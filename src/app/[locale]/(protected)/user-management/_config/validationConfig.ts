// src/app/[locale]/(protected)/user-management/_config/validationConfig.ts
import { z } from "zod";
import { TDataTableDataValidation } from "@/types/dataTable";
import { faker } from "@faker-js/faker";

export const addDataValidationProps: TDataTableDataValidation[] = [
  {
    id: "firstName",
    component: "input",
    label: "First Name",
...
export const editDataValidationProps: TDataTableDataValidation[] = [
  {
    id: "firstName",
    component: "input",
    label: "First Name",
